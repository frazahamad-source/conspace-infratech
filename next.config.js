...
interface PageSetting {
    id: any; // BULLETPROOF: Accepts everything
    title: string;
    path: string;
    isVisible: boolean;
}
        ...
        <div className="space-y-12">
            ...
            <section className="space-y-4">
                <div className="flex justify-between items-center">
                    ...
                    <button onClick={savePages} disabled={isSavingPages} className="btn-admin btn-admin-primary flex items-center space-x-2">
                                    ...
                                    <td className="px-6 py-4">
                                        <label className="relative inline-flex items-center cursor-pointer">
                                            <input
                                                ...
                                                onChange={(e) => handlePageChange(page.id, "isVisible", e.target.checked)}
